...
export class PeopleService {
   ...
   people: Person[] = [
       ...
       { id: 1, firstName: 'Sean', lastName: 'Doyle', dateOfBirth: new Date('01/01/1970') }
   ];

   getPeople(person?: Person): Observable<Person[]> { // getPeople() here right now returns all of the results
